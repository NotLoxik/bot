...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const row = new ActionRowBuilder().addComponents(sourcecode, github);

    const embed = new EmbedBuilder()
      .setColor("#FEE75C")
      .setDescription(
        "This is a template bot made by Loxik, you can view the source code by clicking GitHub button. And dont forget to star my repository."
      );
